    ...
    <div className="body">
      <nav>
        ...
        <div className="searchWrapper">
          <img
            src="./images/hayounglee/magnify.svg"
            alt="searchIc"
            className="searchIc"
          />
        ...
        <div className="navMenu">
          <img
            src="./images/hayounglee/explore.png"
            alt="explore"
            className="ic explore"
          />
          <img
            src="./images/hayounglee/heart.png"
            alt="heart"
            className="ic heart"
          />
          <img
            src="./images/hayounglee/profile.png"
            alt="profile"
            className="ic profile"
          />
        </div>
      </nav>
      <main>
          ...
          <article>
            <header className="article header">
              <div className="userInfo">
                <img
                  src="./images/hayounglee/thumbnail_img1.jpeg"
                  alt="thumbnail"
              ...
              <img
                src="./images/hayounglee/more.svg"
                alt="more"
                className="ic more"
              />
            </header>
            <img
              src="./images/hayounglee/img_example.jpg"
              alt="articleImg"
            ...
            <div className="article footer">
              <div className="icBar">
                <div className="leftsideWrapper">
                  <img
                    src="./images/hayounglee/heart.svg"
                    alt="heart2"
                    className="ic heart2"
                  />
                  <img
                    src="./images/hayounglee/comment.svg"
                    alt="comment"
                    className="ic comment"
                  />
                  <img
                    src="./images/hayounglee/navigation.svg"
                    alt="navigation"
                    className="ic navigation"
                  />
                </div>
                <img
                  src="./images/hayounglee/bookmark.svg"
                  alt="bookmark"
                  className="ic bookmark"
                />
              </div>
      ...
      <section className="rightFloatingMenu">
        <div className="myProfile">
          <img
            src="./images/hayounglee/myImg.jpg"
            alt="나의 프로필 사진"
            className="thumbnail myProfile"
          />
          <div>
